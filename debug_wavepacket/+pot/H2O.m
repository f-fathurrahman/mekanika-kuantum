    ...
    methods (Access = public)
        ...
        function init (~)
            ...
            if hamilt.coupling.n_eqs ~= 2
                prt.error ('This potential only for two Schrödinger equations')
            end
            
            if space.n_dim ~= 2
                prt.error ('This potential is for 2 degrees of freedom only')
            end
        ...
        function disp(obj)
            ...
            if obj.row==1 && obj.col==1
                ...
                prt.disp ('Semi-empirical calculation for the PES of water.  ')
                prt.disp ('***************************************************************')
                prt.disp ('                                                  ')
                prt.disp (['Constant HOH bending angle : ' num2str(obj.gamma)])
