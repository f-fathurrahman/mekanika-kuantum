function [L_heom,heom_structure] = constructHEOMGenerator(H_sys, ...
    heom_bath_info, heom_truncation_info, heom_structure_in)
...
if (nargin~=4)
  ...
  elseif (heom_truncation_info.truncation_method == "lindoy cut-off")
    [ado_indices,ado_gammas,lower_indices,upper_indices, ...
      ...
      ado_indices_term,modes_term,term_indices] = generateHierarchyLindoyTrunc( ...
        heom_truncation_info.L_max, heom_truncation_info.L_min, nus);
  end
