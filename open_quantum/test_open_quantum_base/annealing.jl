...
struct T_OPENSYS <: MyOpenQuantumBase.AbstractLiouvillian end
struct T_COUPLINGS <: MyOpenQuantumBase.AbstractCouplings end
struct T_BATH <: MyOpenQuantumBase.AbstractBath end
