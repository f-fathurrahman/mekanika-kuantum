...
using MyOpenQuantumBase, Test, LinearAlgebra
...
@test vcache₁ == -1.0im * MyOpenQuantumBase.vectorized_commutator(H₁(0.1))
@test vcache₂ == -1.0im * MyOpenQuantumBase.vectorized_commutator(H₂(1))
@test vcache₃ == -1.0im * MyOpenQuantumBase.vectorized_commutator(H₃(2))
