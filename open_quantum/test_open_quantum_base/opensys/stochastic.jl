...
Random.seed!(1234)
MyOpenQuantumBase.reset!(fluct, (x, y) -> rand([-1, 1], x, y))
...
b0[idx] *= -1
Random.seed!(1234)
MyOpenQuantumBase.next_state!(fluct)
