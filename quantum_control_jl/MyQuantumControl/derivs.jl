using MyQuantumPropagators.Generators: Generator, Operator, _make_generator, evaluate
using MyQuantumPropagators.Amplitudes: LockedAmplitude, ShapedAmplitude
