...
using MyQuantumPropagators.Generators: Generator
using MyQuantumPropagators.Controls: get_controls
using MyQuantumPropagators.Interfaces: catch_abbreviated_backtrace
...
function check_generator(
    ...
    success = MyQuantumPropagators.Interfaces.check_generator(
        generator;
        state,
        tlist,
        for_expval,
