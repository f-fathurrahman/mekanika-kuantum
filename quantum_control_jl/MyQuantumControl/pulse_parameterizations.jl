...
using MyQuantumPropagators.Controls: discretize_on_midpoints
using MyQuantumPropagators.Amplitudes: ControlAmplitude, ShapedAmplitude

import MyQuantumPropagators.Controls: evaluate, get_controls
