import Base
import MyQuantumPropagators
using Printf

using MyQuantumPropagators.Generators: Generator, Operator
using MyQuantumPropagators.Controls: _get_parameters
import MyQuantumPropagators.Controls: substitute, get_controls, get_parameters
